...
[2026-06-02] | Mapper des actions CAD sans alignement sur les vrais raccourcis de l'application provoque des commandes inutiles | Toujours baser la table d'actions Python sur les raccourcis officiels fournis (capture ou doc)
